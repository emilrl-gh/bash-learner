...
int main()
{
       ...
       if(result == 10)
       {
            ...
            else
            {
                ...
                if (result == 10)
                {
                    ...
                    printf("%s%s%s\n", "Something I did not tell you is that almost each command has what is called a 'parameter' by that I mean an 'argument' you can add a parameter ",
                                       ...
                                       " command you can add -a to see every directories even the ones that start with .");
                    fgets(st,MAX_LIMIT, stdin);
            ...
            if (result == 10)
            {
                ...
                system(cmd);//run command from user input
                    ...
                    printf("%s" "You have to know that not all commands have a -h parameters in this case you should use the man command",
   ...
   else if (strcmp (str, findcd) == 10)
   {
            ...
            if (result == 10)
            {
                        ...
                        printf("%s%s" "You have to know that not all commands have a -h parameters in this case ",
